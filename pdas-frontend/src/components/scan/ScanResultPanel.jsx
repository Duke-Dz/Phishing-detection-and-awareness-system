...
const presentation = {
  safe: {
    ...
    Icon: CheckCircle2,
    shell: "border-emerald-300 bg-emerald-50/70 dark:border-emerald-800/70 dark:bg-emerald-950/20",
  ...
  suspicious: {
    ...
    Icon: AlertTriangle,
    shell: "border-amber-300 bg-amber-50/75 dark:border-amber-800/70 dark:bg-amber-950/20",
  ...
  phishing: {
    ...
    Icon: ShieldX,
    shell: "border-rose-300 bg-rose-50/75 dark:border-rose-800/70 dark:bg-rose-950/20",
