...
export default function ScanCenter({ onComplete, initialTab = "url", lockedTab = false }) {
  ...
  const fieldClassName = "dashboard-theme-control mt-3 block w-full rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm font-normal text-slate-950 outline-none transition placeholder:font-normal placeholder:text-slate-400 hover:border-slate-400 focus:border-[#087CF0] focus:ring-4 focus:ring-[#087CF0]/10 dark:text-white dark:placeholder:text-slate-500";
  return (
    <section className="dashboard-theme-surface overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
      <div className="dashboard-theme-divider border-b border-slate-200 px-5 py-5 sm:px-8">
