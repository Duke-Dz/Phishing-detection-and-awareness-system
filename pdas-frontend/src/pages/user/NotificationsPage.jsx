...
export default function NotificationsPage() {
  ...
  useEffect(() => { notificationService.list({ page: 1, page_size: 50 }).then((response) => setItems(response.data || [])).catch(() => toast.error("Could not load notifications.")).finally(() => setLoading(false)); }, []);
